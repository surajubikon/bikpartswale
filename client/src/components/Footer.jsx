        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">  
          <div>  
            ...
            <ul className="space-y-2">  
              ...
              <li><a href="/contact-us" className="hover:text-red-500">Contact Us</a></li>  
              <li><a href="/wholesale-prices" className="hover:text-red-500">Wholesale Prices</a></li>  
              ...
              <li><a href="/shipping-policy" className="hover:text-red-500">Shipping Policy</a></li>  
            </ul>  
          </div>  
