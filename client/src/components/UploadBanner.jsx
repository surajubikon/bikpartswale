    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await Axios({
                ...SummaryApi.CreateBannerController, // Updated API endpoint for adding banners
                data: data
            });
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex gap-4 flex-col lg:flex-row items-center'>
                            ...
                            <label htmlFor='uploadBannerImage'>
                                <div className='border-primary-200 hover:bg-primary-100 px-4 py-2 rounded cursor-pointer border font-medium'>Upload Image</div>
                                <input
