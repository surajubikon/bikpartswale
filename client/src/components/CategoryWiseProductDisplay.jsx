...
const CategoryWiseProductDisplay = ({ id, name }) => {
    ...
    return (
        <div className='container mx-auto px-4'>
            <div className="home-heading text-center relative flex flex-col sm:flex-row sm:items-center justify-center sm:justify-between px-4">
                {/* Name (Title) with Border */}
                <h2 className="font-semibold text-lg md:text-xl border-2 border-red-500 px-4 py-1 rounded-md inline-block">
                    {name}
                </h2>

                {/* See All (Styled as a Button) */}
                <Link
                    to={redirectURL}
                    className="text-green-600 font-medium text-sm px-3 py-1 mt-2 sm:mt-0 sm:absolute sm:right-4 sm:top-0 rounded-md border border-green-600 hover:text-green-500 transition">
                    See All
                </Link>
            </div>
